...
if (httpsPort is int httpsSelected)
{
    app.Logger.LogInformation("Selected HTTPS port: {Port}", httpsSelected);
}

if (httpPort is int httpSelected)
{
    app.Logger.LogInformation("Selected HTTP port: {Port}", httpSelected);
}
